# NSU 2.0 Research Collection

## Overview
This document contains comprehensive research on the German Nationalsozialistischer Untergrund (NSU) 2.0, collected from various reliable sources including Wikipedia, Der Spiegel, Deutsche Welle, Bundeszentrale für politische Bildung (bpb), Deutscher Bundestag, and Mediendienst Integration.

## What is NSU 2.0?

NSU 2.0 refers to a series of threatening letters and emails sent since August 2018, signed with "NSU 2.0" - a reference to the original Nationalsozialistischer Untergrund (NSU), a right-wing terrorist group active in Germany from 2000-2007.

### Key Facts:
- **Timeline**: Started August 2018, ongoing
- **Signature**: "NSU 2.0" and variations like "NationalSozialistischeOffensive" (NSO), "Elysium", "Staatsstreichorchester", "Wehrmacht"
- **Targets**: Approximately 70 different individuals and 60 institutions across Germany and Austria
- **Primary targets**: People publicly engaged against racism, antisemitism, for refugees and migrants - mostly women, often with migration backgrounds

## The Original NSU (Context)

The original NSU was a right-wing terrorist group consisting of:
- **Uwe Böhnhardt** (died 2011)
- **Uwe Mundlos** (died 2011) 
- **Beate Zschäpe** (convicted 2018)

### NSU Crimes (2000-2007):
- 10 murders (8 Turkish-German, 1 Greek-German small business owners, 1 police officer)
- 15 robberies
- 3 bomb attacks
- 2 attempted murders

## NSU 2.0 Threat Campaign Details

### Major Incidents:

#### August 2, 2018
- **Target**: Seda Başay-Yıldız (Frankfurt lawyer)
- **Method**: Fax with personal details
- **Significance**: First known NSU 2.0 threat

#### October 2018 - April 2019
- **Perpetrator**: André M.
- **Targets**: 107 threat mails to courts, authorities, media, including Helene Fischer and Katarina Barley
- **Signature**: "NationalSozialistischeOffensive" (NSO), "NSU 2.0", "Staatsstreichorchester"
- **Outcome**: André M. arrested December 2020, sentenced to 4 years for coercion and disturbing public peace

#### September 9, 2018
- **Signature**: "Wehrmacht"
- **Targets**: Amadeu Antonio Foundation, Belltower.News, NSU-Watch

#### July 2020
- **Targets**: Multiple Bundestag members from Die Linke party
  - Amira Mohamed Ali (party leader)
  - Sevim Dagdelen
  - Gökay Akbulut
- **Also targeted**: Green party members including Anton Hofreiter

## Police Involvement Evidence

### Critical Findings:
- Personal data in threat letters accessed from police computers
- Hessian police: 3 confirmed data queries
- Berlin police: 3 confirmed data queries  
- Hamburg police: 2 confirmed data queries
- 180 suspected cases of right-wing extremist police officers in Hesse
- Thousands of illegal data queries discovered in German police authorities

## Key Cases and Investigations

### André M. Case
- Sentenced December 2020 to 4 years imprisonment
- 107 threat mails between October 2018 - April 2019
- Targets included government agencies, media personalities, politicians

### Alexander Horst M. Case
- Sentenced November 2022 to 5 years and 10 months
- 81 threat letters signed "NSU 2.0"
- Additional threats attributed to "copycats"

### Emil A. Case (Berlin)
- Italian national in Berlin
- At least 17 bomb threats and extortion demands to UK's NHS
- Signed "Staatsstreichorchester"
- Sentenced February 2021 to 3 years for robbery extortion

## Parliamentary Investigations

### 3rd NSU Investigation Committee (2017)
- **Focus**: Open questions about NSU terrorist group
- **Duration**: 5.5 years of parliamentary investigation
- **Key Findings**:
  - Strong doubts about "trio theory" (only 3 perpetrators)
  - Evidence of extensive right-wing terrorist networks
  - Systematic failures in security agencies
  - Unresolved DNA traces at crime scenes
  - Inadequate communication between police agencies

### Political Consequences:
- Calls for dissolution of Verfassungsschutz (domestic intelligence)
- Demands to end V-Person (informant) system
- Proposed creation of coordination center for group-focused enmity
- Calls for complete institutional restart of domestic intelligence

## Academic Analysis

### New Type of Right-Wing Violence
According to bpb analysis, NSU represents:
- **Continuity**: Connection to long history of right-wing extremist violence
- **Discontinuity**: New type of violence combining elements of "hot" and "cold" terrorism
- **Characteristics**:
  - Systematically planned attacks
  - Ideological self-purpose (not primarily communicative)
  - Focus on physical elimination of ideological enemies
  - Long-term stable group structure (unusual for right-wing groups)

## Key Personalities and Experts

### Martina Renner (Die Linke)
- Member of multiple NSU investigation committees
- Received threat email from "Nationalsozialistische Offensive" 
- Warns about "new right-wing racists" who don't fit classic neonazi profile
- Highlights threat of networks transitioning "from words to deeds"
- Notes unprecedented weapons circulation among neonazis (pipe bombs, live ammunition)

### Seda Başay-Yıldız
- Frankfurt lawyer representing NSU victims' families
- First known NSU 2.0 target (August 2, 2018)
- Received multiple threats with personal data accessed from police systems
- Key figure in exposing police involvement

### Other Key Figures:
- **Amira Mohamed Ali**: Die Linke party leader, threatened July 2020
- **Anton Hofreiter**: Green party leader, also threatened
- **Aiman Mazyek**: Central Council of Muslims chairman, received "Heil Hitler Dein NSU 2.0" threat
- **Idil Baydar**: Cabaret artist, threatened

## Sources and Further Reading

### Primary Sources:
1. **Wikipedia**: NSU 2.0 entry - comprehensive overview
2. **Der Spiegel**: Multiple articles on threat campaigns and political reactions
3. **Deutsche Welle**: Analysis of police involvement and political implications
4. **bpb**: Academic analysis of NSU as new type of right-wing violence
5. **Deutscher Bundestag**: Parliamentary investigation reports and debates
6. **Mediendienst Integration**: Statistical overview and context
7. **Konrad-Adenauer-Stiftung**: Political analysis and historical context
8. **Nachrichtenleicht**: Simplified explanation for broader audience
9. **Amazon Book**: "Nationalsozialistischer Untergrund": Zehn Jahre danach und kein Schlussstrich" - Academic collection

### Key Documents:
- Bundestag Investigation Committee Report (18/12950)
- NSU trial transcripts and verdicts
- Police internal investigation reports
- Academic analyses of right-wing terrorism
...
- "Die Zelle. Rechter Terror in Deutschland" (Christian Fuchs, John Goetz)

## Recent Legal Developments (2023-2025)

### February 2024: Police Investigation Discontinued
- **Frankfurt Prosecutor's Office**: Discontinued investigations against two police officers in NSU 2.0 complex
- **Date**: December 7, 2023 (announced February 2024)
- **Reason**: "Insufficient suspicion" could not be established against the officers
- **Background**: One officer was logged into computer when unauthorized data query occurred; colleague was also on duty
- **Appeal**: Complaint filed against the decision
- **Key Issue**: Personal data accessed from police computer in 1st Frankfurt police precinct was used in August 2018 threat fax to Seda Başay-Yıldız

### March 2024: Federal Court of Justice Decision
- **Bundesgerichtshof**: Final ruling on Alexander M. case (March 21, 2024)
- **Outcome**: Frankfurt Regional Court verdict (November 17, 2022) upheld with minor modifications
- **Final Sentence**: 5 years and 10 months imprisonment for Alexander M.
- **Key Findings**:
  - Alexander M. acted alone as sole perpetrator
  - 67 cases of threatening emails, faxes, and SMS between August 2018 and March 2021
  - Used "NSU 2.0" signature and "Heil Hitler" slogans
  - Manipulated police and officials by pretending to be prosecutor/relative
  - Stored police station phone numbers with notes like "Never call as prosecutor again!"
  - No connections to police officers or supporters found
  - Four unauthorized police data queries occurred during crime period, but no link to perpetrator

### Ongoing Concerns Despite Legal Conclusions
- **Data Source Mystery**: How Alexander M. obtained personal data remains unclear
- **Police Data Queries**: Four confirmed unauthorized queries from police computers during threat period
- **Right-wing Chat Groups**: Discovery of right-wing extremist chat group within Frankfurt police precinct
- **Systemic Issues**: Questions about broader right-wing networks in security agencies remain

## Ongoing Concerns

### Current Situation:
- NSU 2.0 threats continue to be sent
- Evidence suggests ongoing right-wing networks in security agencies
- Parliamentary and public calls for comprehensive reforms
- International attention to German right-wing terrorism

### Unresolved Questions:
- Full extent of right-wing networks in police and intelligence agencies
- Complete identification of all NSU 2.0 perpetrators
- Adequacy of current security agency reforms
- Long-term prevention strategies
- Source of personal data used in threats (police queries confirmed but perpetrator connection denied)

### Systemic Issues Identified:
- Right-wing chat groups within police precincts
- Unauthorized data access from police computers
...
- **2024 Statistics**: Right-wing extremist crimes reached 41,406 offenses - 40% higher than 2023
- **Historical Context**: Highest level since Nazi rule according to Left Party inquiry
- **Violent Crimes**: 1,443 violent crimes recorded in 2024
- **Underreporting**: Authorities systematically underestimate right-wing motives
- **State Apparatus Infiltration**: Evidence of far-right structures within government agencies

### Political Climate Impact
- **Normalization**: Right-wing extremist views increasingly socially acceptable
- **Government Response**: Interior Minister Nancy Faeser expanded police powers while attacking refugees
- **Political Attacks**: Crimes against elected officials increased from 4,047 to 4,923 in 2024
- **Election Violence**: Multiple attacks on Left Party and SPD campaign stands

### Historical Recognition Issues
- **Delayed Recognition**: Many right-wing murders only classified as such after decades
- **Examples**: 
  - Horst Pulter murder (1995) took 20 years for right-wing classification
  - Alexander Selchow murder (1991) still not properly classified
  - Walter Lübcke murder (2019) by right-wing extremist
- **Statistics Gap**: Amadeu Antonio Foundation lists 219 right-wing murders since 1990, but only 116 in official statistics

### NSU 2.0 in Current Context
- **Pattern**: Part of broader surge in right-wing violence and state apparatus infiltration
- **Impunity**: "Of far-right police officers behind 'NSU 2.0' wave of death threats, only a handful were prosecuted"
- **Systemic Protection**: Evidence of state apparatus covering up right-wing activities
